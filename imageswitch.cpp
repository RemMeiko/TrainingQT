...
ImageSwitch::ImageSwitch(QWidget *parent) : QWidget(parent)
{
    ...
    imgOffFile = ":/resources/imageswitch/btncheckoff3.png";
    imgOnFile = ":/resources/imageswitch/btncheckon3.png";
    imgFile = imgOffFile;
}
...
void ImageSwitch::setButtonStyle(const ImageSwitch::ButtonStyle &buttonStyle)
{
    if (this->buttonStyle != buttonStyle) {
        ...
        if (buttonStyle == ButtonStyle_1) {
            imgOffFile = ":/resources/imageswitch/btncheckoff1.png";
            imgOnFile = ":/resources/imageswitch/btncheckon1.png";
            this->resize(87, 28);
        } else if (buttonStyle == ButtonStyle_2) {
            imgOffFile = ":/resources/imageswitch/btncheckoff2.png";
            imgOnFile = ":/resources/imageswitch/btncheckon2.png";
            this->resize(87, 28);
...
// 鼠标释放事件处理 槽函数和信号
void ImageSwitch::mouseReleaseEvent(QMouseEvent * ev)
{
    Q_UNUSED(ev)
    emit clicked();
}
